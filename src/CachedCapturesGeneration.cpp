...
auto CachedCapturesGeneration::get_cached_knight_capture_positions(const BitBoard knights_bit_board) noexcept ->BitBoard {
...
auto CachedCapturesGeneration::get_cached_king_capture_positions(const BitBoard kings_bit_board) noexcept -> BitBoard {
  BitBoard capturable_bit_board = BitBoards::EMPTY;
