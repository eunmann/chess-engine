...
namespace CachedCapturesGeneration {
    ...
    auto get_cached_knight_capture_positions(BitBoard knights_bit_board) noexcept -> BitBoard;
    ...
    auto get_cached_king_capture_positions(BitBoard kings_bit_board) noexcept -> BitBoard;

    template<const Color color>
    auto get_capture_positions(const Position &position) noexcept -> BitBoard {
        BitBoard capturable_bit_board = BitBoards::EMPTY;
        capturable_bit_board |= CachedCapturesGeneration::get_cached_pawn_capture_positions<color>(
                position.get_piece_color_bit_board<PieceCodes::PAWN, color>());
        capturable_bit_board |= CachedCapturesGeneration::get_cached_knight_capture_positions(
        ...
        capturable_bit_board |= CachedCapturesGeneration::get_cached_king_capture_positions(
