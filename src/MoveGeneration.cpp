...
auto MoveGeneration::get_cached_knight_capture_positions(const BitBoard knights_bit_board) noexcept ->BitBoard {
  ...
  BitBoardUtils::for_each_set_square(knights_bit_board, [&capturable_bit_board](auto knight_square) {
    capturable_bit_board |= CachedMoves::KNIGHT[knight_square];
    });
  return capturable_bit_board;
}
...
auto MoveGeneration::get_king_capture_positions(const BitBoard bit_board) noexcept -> BitBoard {
  ...
  BitBoardUtils::for_each_bit_board(bit_board, [&capturable_bit_board](const BitBoard king_bit_board) {
    // Up
    {
...
auto MoveGeneration::get_cached_king_capture_positions(const BitBoard kings_bit_board) noexcept -> BitBoard {
  ...
  BitBoardUtils::for_each_set_square(kings_bit_board, [&capturable_bit_board](auto king_square) {
    capturable_bit_board |= CachedMoves::KING[king_square];
    });
  return capturable_bit_board;
