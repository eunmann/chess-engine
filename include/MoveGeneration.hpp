...
namespace MoveGeneration {
  ...
  constexpr auto get_moves_in_direction(const GameState& game_state,
    BitBoard bit_board, Moves& moves)
    -> void {
    ...
    for (int i = 0; i < 7; ++i) {
      ...
      if (game_state.position.is_empty(bit_board)) {
        moves.push_back(
          Move(source_square, GameUtils::bit_board_to_square(bit_board)));
  ...
  constexpr auto get_pawn_moves(const GameState& game_state, Moves& moves)
    ...
    GameUtils::for_each_bit_board(
      pawns_bit_board,
      [&game_state, &moves, pawn_dir](const BitBoard pawn_bit_board) {
        ...
        BitBoard pawn_bit_board_left_capture =
          GameUtils::is_piece_in_left_col(pawn_bit_board)
          ? 0
          : GameUtils::shift_bit_board<1 * pawn_dir, -1>(pawn_bit_board);
        BitBoard pawn_bit_board_right_capture =
          GameUtils::is_piece_in_right_col(pawn_bit_board)
          ? 0
          : GameUtils::shift_bit_board<1 * pawn_dir, 1>(pawn_bit_board);

        if (game_state.position.is_color_occupied<opponent_color>(
        ...
        BitBoard source_bit_board =
          GameUtils::square_to_bit_board(source_square);
  ...
  template <const Color color>
  constexpr auto get_knight_moves(const GameState& game_state, Moves& moves)
    -> void {
    BitBoard knights_bit_board =
      game_state.position
      .get_piece_color_bit_board<PieceCodes::KNIGHT, color>();

    GameUtils::for_each_bit_board(
      knights_bit_board,
      [&game_state, &moves](const BitBoard knight_bit_board) {
        ...
        if (!(GameUtils::is_piece_in_top_2_row(knight_bit_board) ||
          ...
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<2, -1>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
            next_knight_bit_board)));
        }

        if (!(GameUtils::is_piece_in_top_row(knight_bit_board) ||
          GameUtils::is_piece_in_left_2_col(knight_bit_board))) {
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<1, -2>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
            next_knight_bit_board)));
        }

        if (!(GameUtils::is_piece_in_bottom_row(knight_bit_board) ||
          GameUtils::is_piece_in_left_2_col(knight_bit_board))) {
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<-1, -2>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
        ...
        if (!(GameUtils::is_piece_in_bottom_2_row(knight_bit_board) ||
          GameUtils::is_piece_in_left_col(knight_bit_board))) {
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<-2, -1>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
        ...
        if (!(GameUtils::is_piece_in_bottom_2_row(knight_bit_board) ||
          GameUtils::is_piece_in_right_col(knight_bit_board))) {
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<-2, 1>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
            next_knight_bit_board)));
        ...
        if (!(GameUtils::is_piece_in_bottom_row(knight_bit_board) ||
          GameUtils::is_piece_in_right_2_col(knight_bit_board))) {
          BitBoard next_knight_bit_board =
            GameUtils::shift_bit_board<-1, 2>(knight_bit_board);
          moves.push_back(Move(source_square, GameUtils::bit_board_to_square(
            next_knight_bit_board)));
  ...
  template <const Color color>
  constexpr auto get_bishop_moves(const GameState& game_state, Moves& moves)
    -> void {
    BitBoard bishops_bit_board =
      game_state.position
      .get_piece_color_bit_board<PieceCodes::BISHOP, color>();

    GameUtils::for_each_bit_board(
      bishops_bit_board,
      [&game_state, &moves](const BitBoard bishop_bit_board) {
        MoveGeneration::get_moves_in_direction<1, 1, color>(
          game_state, bishop_bit_board, moves);
        MoveGeneration::get_moves_in_direction<-1, 1, color>(
          game_state, bishop_bit_board, moves);
        MoveGeneration::get_moves_in_direction<1, -1, color>(
          game_state, bishop_bit_board, moves);
  ...
  template <const Color color>
  constexpr auto get_rook_moves(const GameState& game_state, Moves& moves)
    -> void {
    BitBoard rooks_bit_board =
      game_state.position.get_piece_color_bit_board<PieceCodes::ROOK, color>();

    GameUtils::for_each_bit_board(
      rooks_bit_board, [&game_state, &moves](const BitBoard rook_bit_board) {
        MoveGeneration::get_moves_in_direction<1, 0, color>(
          game_state, rook_bit_board, moves);
        MoveGeneration::get_moves_in_direction<-1, 0, color>(
          game_state, rook_bit_board, moves);
        MoveGeneration::get_moves_in_direction<0, -1, color>(
          game_state, rook_bit_board, moves);
        MoveGeneration::get_moves_in_direction<0, 1, color>(
          game_state, rook_bit_board, moves);
      });
  ...
  template <const Color color>
  constexpr auto get_queen_moves(const GameState& game_state, Moves& moves)
    -> void {
    BitBoard queens_bit_board =
      game_state.position.get_piece_color_bit_board<PieceCodes::QUEEN, color>();
    GameUtils::for_each_bit_board(
      queens_bit_board, [&game_state, &moves](BitBoard queen_bit_board) {
        // Diagonal
        MoveGeneration::get_moves_in_direction<1, 1, color>(
          game_state, queen_bit_board, moves);
        MoveGeneration::get_moves_in_direction<-1, 1, color>(
          game_state, queen_bit_board, moves);
        MoveGeneration::get_moves_in_direction<1, -1, color>(
          game_state, queen_bit_board, moves);
  ...
  template <const Color color>
  constexpr auto get_king_moves(const GameState& game_state, Moves& moves)
    -> void {
    BitBoard kings_bit_board =
      game_state.position.get_piece_color_bit_board<PieceCodes::KING, color>();

    GameUtils::for_each_bit_board(kings_bit_board, [&game_state, &moves](
      BitBoard king_bit_board) {
        ...
        if (!GameUtils::is_piece_in_top_row(king_bit_board)) {
          BitBoard next_king_bit_board =
            GameUtils::shift_bit_board<1, 0>(king_bit_board);
          moves.push_back(Move(
            source_square, GameUtils::bit_board_to_square(next_king_bit_board)));
        }
        ...
        if (!GameUtils::is_piece_in_left_col(king_bit_board)) {
          BitBoard next_king_bit_board =
            GameUtils::shift_bit_board<0, -1>(king_bit_board);
          moves.push_back(Move(
            source_square, GameUtils::bit_board_to_square(next_king_bit_board)));
        }
        ...
        // Up-Right
        if (!(GameUtils::is_piece_in_top_row(king_bit_board) ||
          GameUtils::is_piece_in_right_col(king_bit_board))) {
          BitBoard next_king_bit_board =
            GameUtils::shift_bit_board<1, 1>(king_bit_board);
          moves.push_back(Move(
            source_square, GameUtils::bit_board_to_square(next_king_bit_board)));
        }
        ...
        // Up-Left
        if (!(GameUtils::is_piece_in_top_row(king_bit_board) ||
          GameUtils::is_piece_in_left_col(king_bit_board))) {
          BitBoard next_king_bit_board =
            GameUtils::shift_bit_board<1, -1>(king_bit_board);
          moves.push_back(Move(
            source_square, GameUtils::bit_board_to_square(next_king_bit_board)));
        ...
        if (!game_state.has_king_moved<color>() &&
          ...
          constexpr Color opponent_color =
            color == Colors::WHITE ? Colors::BLACK : Colors::WHITE;
          constexpr BitBoard queen_castle = color == Colors::WHITE
            ? BitBoards::WHITE_QUEEN_CASTLE
            : BitBoards::BLACK_QUEEN_CASTLE;
          // Queen Side
          ...
          constexpr BitBoard king_castle = color == Colors::WHITE
  ...
  template <const Color color>
  constexpr auto get_moves(const GameState& game_state, Moves& moves) noexcept
    -> void {
  ...
  template <const Color color>
  constexpr auto get_pawn_capture_positions(const Position& position)
    -> BitBoard {
    constexpr int64_t pawn_dir = color == Colors::WHITE ? 1 : -1;
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard pawns_bit_board =
      position.get_piece_color_bit_board(PieceCodes::PAWN, color);
    GameUtils::for_each_bit_board(
      pawns_bit_board,
      [&capturable_bit_board, pawn_dir](BitBoard pawn_bit_board) {
        // Capture Left and Right
        BitBoard pawn_bit_board_left_capture =
          GameUtils::is_piece_in_left_col(pawn_bit_board)
          ? 0
        ...
        capturable_bit_board |=
          pawn_bit_board_left_capture | pawn_bit_board_right_capture;
      });
    return capturable_bit_board;
  }

  template <const Color color>
  constexpr auto get_knight_capture_positions(const Position& position)
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard knights_bit_board =
  ...
  template <const Color color>
  constexpr auto get_bishop_capture_positions(const Position& position)
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard bishops_bit_board =
      position.get_piece_color_bit_board(PieceCodes::BISHOP, color);
    GameUtils::for_each_bit_board(
      bishops_bit_board,
      [&capturable_bit_board, &position](BitBoard bishop_bit_board) {
        capturable_bit_board |= MoveGeneration::get_captures_in_direction<1, 1>(
          position, bishop_bit_board);
        capturable_bit_board |=
          MoveGeneration::get_captures_in_direction<-1, 1>(position,
            bishop_bit_board);
        capturable_bit_board |=
          MoveGeneration::get_captures_in_direction<1, -1>(position,
            bishop_bit_board);
  ...
  template <const Color color>
  constexpr auto get_rook_capture_positions(const Position& position)
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard rooks_bit_board =
      position.get_piece_color_bit_board(PieceCodes::ROOK, color);
    GameUtils::for_each_bit_board(
      rooks_bit_board,
      [&capturable_bit_board, &position](BitBoard rook_bit_board) {
        capturable_bit_board |= MoveGeneration::get_captures_in_direction<1, 0>(
          position, rook_bit_board);
        capturable_bit_board |=
          MoveGeneration::get_captures_in_direction<-1, 0>(position,
            rook_bit_board);
        capturable_bit_board |=
          MoveGeneration::get_captures_in_direction<0, -1>(position,
            rook_bit_board);
        capturable_bit_board |= MoveGeneration::get_captures_in_direction<0, 1>(
          position, rook_bit_board);
      });
    return capturable_bit_board;
  }
  ...
  template <const Color color>
  constexpr auto get_queen_capture_positions(const Position& position)
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard queens_bit_board =
      position.get_piece_color_bit_board(PieceCodes::QUEEN, color);
    GameUtils::for_each_bit_board(
      queens_bit_board,
      [&capturable_bit_board, &position](BitBoard queen_bit_board) {
        // Diagonal
        capturable_bit_board |= MoveGeneration::get_captures_in_direction<1, 1>(
          position, queen_bit_board);
        capturable_bit_board |=
          MoveGeneration::get_captures_in_direction<-1, 1>(position,
            queen_bit_board);
        capturable_bit_board |=
  ...
  template <const Color color>
  constexpr auto get_king_capture_positions(const Position& position)
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    BitBoard kings_bit_board =
      position.get_piece_color_bit_board(PieceCodes::KING, color);

    GameUtils::for_each_bit_board(
      kings_bit_board, [&capturable_bit_board](const BitBoard king_bit_board) {
        // Up
        if (!GameUtils::is_piece_in_top_row(king_bit_board)) {
  ...
  template <const Color color>
  constexpr auto get_capture_positions(const Position& position) noexcept
    -> BitBoard {
    BitBoard capturable_bit_board = BitBoards::EMPTY;
    capturable_bit_board |=
      MoveGeneration::get_pawn_capture_positions<color>(position);
    capturable_bit_board |=
      MoveGeneration::get_knight_capture_positions<color>(position);
    capturable_bit_board |=
      MoveGeneration::get_bishop_capture_positions<color>(position);
    capturable_bit_board |=
      MoveGeneration::get_rook_capture_positions<color>(position);
    capturable_bit_board |=
      MoveGeneration::get_queen_capture_positions<color>(position);
    capturable_bit_board |=
      MoveGeneration::get_king_capture_positions<color>(position);
    return capturable_bit_board;
  }
} // namespace MoveGeneration